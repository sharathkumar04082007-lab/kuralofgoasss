...
class Settings(BaseSettings):
    ...
    STT_PROVIDER: str = Field(default="mock", description="sarvam, elevenlabs, or mock")
    ...
    STT_TIMEOUT_SECONDS: float = Field(default=5.0, description="STT request timeout")
    STT_LANGUAGE_CODE: str = Field(default="hi-IN", description="Default STT language code for multilingual audio")
    
    # LLM / Answer Generation configuration
    LLM_PROVIDER: str = Field(default="local", description="local, groq, gemini, or mock")
